...
class EthereumController {
  ...
  //  @GetMapping("/create/address")
    fun generateGenericBlock(): ResponseEntity<jp.co.soramitsu.bootstrap.dto.BlockchainCreds> {
...
// Web3j
        ...
        return ResponseEntity.ok<jp.co.soramitsu.bootstrap.dto.BlockchainCreds>(
            jp.co.soramitsu.bootstrap.dto.BlockchainCreds(
                credentials.ecKeyPair.privateKey.toString(16),
