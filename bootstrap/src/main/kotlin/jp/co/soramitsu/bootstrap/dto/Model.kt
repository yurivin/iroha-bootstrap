...
data class GenesisResponse(val blockData: String? = null) : jp.co.soramitsu.bootstrap.dto.Conflicatable()
...
class PassiveAccountPrototype(
    ...
    quorum:Int = 1
) : jp.co.soramitsu.bootstrap.dto.AccountPrototype(name,domainId,roles,details,passive = true,quorum = quorum) {
